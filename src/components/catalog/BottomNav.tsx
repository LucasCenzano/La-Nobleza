      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 pb-safe shadow-[0_-2px_10px_rgba(0,0,0,0.02)] z-50 md:hidden">
        <div className="flex justify-around items-center h-16 px-2">
          ...
          >
            {showScrollTop ? (
              <>
                <svg className="w-6 h-6 mb-1 text-[#C5A059] animate-in slide-in-from-bottom-2 duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l7-7m0 0l7 7m-7-7v18" />
                </svg>
                <span className="text-[10px] font-bold text-[#C5A059] animate-in fade-in duration-300">Arriba</span>
              </>
            ) : (
              <>
          ...
          <div className="bg-white w-full sm:max-w-md max-h-[90vh] rounded-t-[2rem] sm:rounded-[2rem] overflow-hidden flex flex-col shadow-2xl relative animate-slide-up">
            ...
            <div className="overflow-y-auto w-full pb-safe">
              <div className="pt-10 px-6 pb-4">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-500">{config?.direccion || 'Los Ceibos 19 B, A4400 Salta'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full bg-gray-100 flex-shrink-0" style={{ height: '350px' }}>
                <iframe
                  src={`https://maps.google.com/maps?q=${encodeURIComponent(config?.direccion || 'Los Ceibos 19 B, A4400 Salta')}&t=&z=15&ie=UTF8&iwloc=&output=embed`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  loading="lazy"
              ...
              <div className="p-6">
                <a
                  href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(config?.direccion || 'Los Ceibos 19 B, A4400 Salta')}`}
                  target="_blank"
          ...
          <div className="bg-white w-full sm:max-w-md rounded-t-[2rem] sm:rounded-[2rem] overflow-hidden flex flex-col shadow-2xl relative animate-slide-up">
            ...
            <div className="p-8 pb-10 flex flex-col items-center text-center">
              ...
              <div className="w-full flex flex-col gap-3">
                <a
                  href={`https://wa.me/${config?.telefono || '5493875875560'}`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  WhatsApp ({config?.telefono || '03875875560'})
                </a>

                <a
                  href={`https://www.instagram.com/${config?.instagram || 'pollerialanobleza'}`}
                  target="_blank"
                  rel="noopener noreferrer"
