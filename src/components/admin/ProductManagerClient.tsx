...
export default function ProductManagerClient({ initialProductos, categorias }: Props) {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="sticky top-[56px] z-40 bg-gray-50/95 backdrop-blur-md -mx-4 px-4 py-4 mb-2 border-b border-gray-200/50">
        {/* Mini stat chips */}
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 mb-4">
          {[
            ...
            <button
              ...
              className={`${chip.color} rounded-xl px-3 py-2 text-center transition-all hover:shadow-sm hover:-translate-y-0.5 ${chip.active ? 'ring-2 ring-offset-1 ring-current shadow-sm' : ''
                }`}
            >
